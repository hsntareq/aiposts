    ...
    <aside>
        <div class="ap-relative ap-px-2 ap-py-10" x-data="{ open: true }">
            <div class="ap-mb-10 ap-ml-3">
                ...
                <button x-on:click="open = ! open" class="ap-absolute ap--right-5 ap-rounded-full ap-p-3 ap-bg-white ap-top-20">
                    <!--Open Icon-->
                    <svg x-show="!open" class="ap-rotate-180" width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav x-bind:class="!open">
                <ul class="ap-text-base ap-text-gray-400">
                    <li>
                        <a class="ap-flex ap-items-center ap-px-4 ap-py-3  hover:ap-text-white ap-rounded-md hover:ap-bg-gradient-to-r ap-from-[#7367F0] ap-to-[#9D95F5]" href="#">
    ...
    <section class="ap-bg-[#F1F0FD] ap-flex-1 ap-flex ap-flex-col">
            ...
            <div class="ap-flex ap-justify-between ap-items-center">
                <div class="ap-top-left ap-flex">
                    <div class="ap-flex ap-mr-4">
                        <input type="search" placeholder="Search Services" class="ap-w-96 ap-rounded-md ap-border ap-border-gray ap-px-3 ap-py-2.5 ap-text-sm">
                    </div>
                    <div class="ap-flex">
                        <button class="ap-flex ap-px-3 ap-py-2.5 ap-text-white ap-rounded-md ap-bg-gradient-to-r ap-from-[#7367F0] ap-to-[#9D95F5]">
                            <?php _get_svg('sr_plus') ?>
                            <span class="ap-text-sm ap-pl-2">Add Client</span>
                        </button>

                        <a class="ap-flex ap-px-3 ap-py-2.5 ap-text-black" href="<?php echo esc_url(add_query_arg('page', 'ap-option', admin_url('admin.php'))); ?>"><?php _get_svg('sr_cog', true); ?></a>
                ...
                <div class="ap-top-right">
                    <ul class="ap-flex ap-justify-between ap-items-center ap-gap-5">
                        ...
                        <li><a href="" class="ap-relative">
                                ...
                                <div class="ap-absolute ap-right-0 ap-top-0">
                                    <span class="ap-relative ap-flex ap-h-3 ap-w-3">
                                        <span class="ap-animate-ping ap-absolute ap-inline-flex ap-h-full ap-w-full ap-rounded-full ap-bg-red-400 ap-opacity-75"></span>
                                        <span class="ap-relative ap-inline-flex ap-rounded-full ap-h-3 ap-w-3 ap-bg-red-500"></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                        <li class="ap-flex ap-justify-between ap-items-center">
                            <div class="ap-flex ap-justify-between ap-items-center">
                                <img width="40" height="40" src="<?php echo AIPOSTS_ASSET_URL ?>images/ellipse.png" alt="photo">
        ...
        <main class="ap-flex-1 ap-overflow-scroll ap-p-5">
            ...
            <div class="ap-main-top ap-grid ap-grid-cols-4 ap-gap-4 ap-pb-10">
                <div class="ap-bg-white ap-rounded ap-flex ap-items-start ap-px-3 ap-py-5  ap-border-b-8 ap-border-indigo-500">
                ...
                <div class="ap-bg-white ap-rounded ap-flex ap-items-start ap-px-3 ap-py-5  ap-border-b-8 ap-border-[#EA5455]">
                ...
                <div class="ap-bg-white ap-rounded ap-flex ap-items-start ap-px-3 ap-py-5  ap-border-b-8 ap-border-[#00CFE8]">
                ...
                <div class="ap-bg-white ap-rounded ap-flex ap-items-start ap-px-3 ap-py-5  ap-border-b-8 ap-border-[#FF9F43]">
