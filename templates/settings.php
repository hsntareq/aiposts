<?php
/**
 * Option settings template for aiposts.
 *
 * @package wp-plugin
 */
...
<div class="ap-h-full ap-m-[50px]">
	<div class="ap-flex ap-items-end ap-justify-between ap-w-full xl:ap-w-3/4 ap-pb-3">
		...
		<button type="submit" form="settings_form"
			class="button button-primary !ap-py-1 !ap-px-6 !ap-text-lg ap-tracking-wider ap-shadow-sm !ap-rounded-md">Save</button>
	</div>
		...
		<main class="ap-flex-1">
			...
			<form id="settings_form" method="post" action="<?php echo admin_url( 'admin-post.php' ); ?>">
				...
				<input type='hidden' name='redirect_to'
					value='<?php echo esc_url( add_query_arg( 'page', 'ap-settings', admin_url( 'admin.php' ) ) ); ?>'>
